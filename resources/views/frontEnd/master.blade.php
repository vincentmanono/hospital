    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item  active" data-interval="2500">
            <img height="500px" width="100%" class="d-block w-100" src="{{ asset('/frontEnd/images/slider/slider1.jpg') }}" alt="First slide">
          </div>
          <div class="carousel-item  " data-interval="2500">
            <img  height="500px" width="100%" class="d-block w-100" src="{{ asset('/frontEnd/images/slider/slider2.jpg') }}" alt="Second slide">
          </div>
          <div class="carousel-item  " data-interval="2500">
            <img  height="500px" width="100%" class="d-block w-100" src="{{ asset('/frontEnd/images/about.jpg') }}" alt="Third slide">
          </div>
        </div>
      </div>
</div>
                    ...
                    <div class="col-md-7 wrap-about py-4 py-md-5 ftco-animate">
                        ...
                        <div class="pl-md-5 ml-md-5 mb-5">
                            <p>SAWAPRINT is a branding and printing company based in the heart of
                                ...
                                We are a one-stop shop for all your branding and printing requirements;
                                our customized solutions are tailored specifically to your individual
                                needs, ensuring the best results every time throughout the prepress,
                                value for our customers who are looking for
                                printing, finishing and binding process. At Sawa Print we believe in
            ...
            <div class="row">
                    ...
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch"
                                style="background-image: url({{ asset('frontEnd') }}/images/doc-1.jpg);"></div>
                        </div>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch"
                                style="background-image: url({{ asset('frontEnd') }}/images/doc-2.jpg);"></div>
                        </div>
                        <div class="text pt-3 text-center">
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch"
                                style="background-image: url({{ asset('frontEnd') }}/images/doc-3.jpg);"></div>
                        </div>
                        <div class="text pt-3 text-center">
                            <h3>Dr. Ian Smith</h3>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="staff">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch"
                                style="background-image: url({{ asset('frontEnd') }}/images/doc-4.jpg);"></div>
                        </div>
                        <div class="text pt-3 text-center">
